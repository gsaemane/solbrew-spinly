...
const StockManager: React.FC = () => {
  ...
  const [newItem, setNewItem] = useState({id:'', name: '', quantity: 0, color: '#D5AE60', image: '', isWinner:true });
  ...
  return (
    <div className="mt-8">
      ...
      {/* Row end */}
        ...
        <button onClick={handleSaveItem} className=" text-red-200 p-3 w-1/2 m-auto mt-3 rounded hover:bg-spot-gold hover:text-spot-black lg:bg-red-600">
          Add Item
        </button>
      </div>
      {/* item list */}
